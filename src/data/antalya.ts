...
export const blogPlaces = [
  { title: "კალეიჩი (ძველი ქალაქი)", desc: "ანტალიის ისტორიული ცენტრი ვიწრო ქუჩებით, ოსმალური არქიტექტურით და ხიბლავს ყველა ტურისტს." },
  ...
  { title: "მადრინა აკვაპარკი", desc: "თურქეთის ერთ-ერთი უდიდესი აკვაპარკი — იდეალურია ოჯახებისთვის." },
  { title: "ოლიმპოსის ტელეფერიკი", desc: "კაბელ-ვაგონით ასვლა თაჰტალის მთაზე (2,365 მ) — თვალწარმტაცი ხედები." },
