    ...
    <section className="bg-gradient-to-r from-orange-500 to-orange-600 px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a href={finalCta.bookingUrl} className="inline-flex items-center gap-2 rounded-full bg-white px-10 py-4 text-lg font-bold text-orange-600 shadow-xl transition-all hover:bg-orange-50 active:scale-95">{finalCta.ctaText}</a>
