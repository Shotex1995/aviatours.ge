...
import type { GalleryImage } from "@/data/tour-landing.types";
import Lightbox from "@/components/ui/Lightbox";

export default function GallerySection({ galleryImages, subheading }: { galleryImages: GalleryImage[]; subheading: string }) {
