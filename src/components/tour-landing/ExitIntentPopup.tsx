  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
        ...
        <p className="mb-6 text-center text-gray-500">მიიღეთ <span className="font-bold text-orange-600">10% ფასდაკლება</span> {exitIntent.tourName} ტურზე. პრომო კოდი:</p>
        <div className="mb-6 rounded-xl bg-orange-50 p-4 text-center">
          <span className="text-2xl font-extrabold tracking-widest text-orange-600">{exitIntent.promoCode}</span>
        </div>
        <a href={`https://wa.me/995558302303?text=${msg}`} target="_blank" rel="noopener noreferrer" className="block w-full rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 py-4 text-center text-lg font-bold text-white shadow-lg shadow-orange-500/25 transition-all hover:from-orange-600 hover:to-orange-700 active:scale-95">გამოიყენე ფასდაკლება</a>
