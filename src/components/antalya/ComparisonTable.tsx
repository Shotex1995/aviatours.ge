import { comparisonFeatures } from "@/data/antalya";
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <th className="px-4 py-4 text-center text-sm font-semibold text-gray-600">ბიუჯეტური<br /><span className="text-orange-500">1,550₾</span></th>
                <th className="px-4 py-4 text-center text-sm font-semibold text-orange-600">პრემიუმი<br /><span className="text-orange-500">4,850₾</span></th>
              </tr>
            </thead>
            <tbody>
