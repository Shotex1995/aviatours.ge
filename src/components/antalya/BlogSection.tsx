import { blogPlaces } from "@/data/antalya";
    ...
    <section className="bg-white px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <div className="mb-10 text-center">
          ...
          <h2 className="mb-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">ანტალიაში ნახვის 10 საუკეთესო ადგილი</h2>
          <p className="text-gray-500">რას ნახავთ ანტალიაში — გიდი ტურისტებისთვის</p>
        </div>
